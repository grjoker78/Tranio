...
with open('file_1.txt', 'w') as f_1:
    for j in range(0, len(line), 5): f_1.write(line[j])
with open('file_2.txt', 'w') as f_2:
    for j in range(1, len(line), 5): f_2.write(line[j])
with open('file_3.txt', 'w') as f_3:
    for j in range(2, len(line), 5): f_3.write(line[j])
with open('file_4.txt', 'w') as f_4:
    for j in range(3, len(line), 5): f_4.write(line[j])
with open('file_5.txt', 'w') as f_5:
    for j in range(4, len(line), 5): f_5.write(line[j])